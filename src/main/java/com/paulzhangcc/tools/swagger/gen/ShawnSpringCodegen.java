...
public class ShawnSpringCodegen extends AbstractJavaCodegen
    ...
    public ShawnSpringCodegen() {
        super();

        apiTemplateFiles.remove("api.mustache", ".java");

        outputFolder = "generated-code/javaSpring";
        apiTestTemplateFiles.clear();
        embeddedTemplateDir = templateDir = "ShawnSpring";
