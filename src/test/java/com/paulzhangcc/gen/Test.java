...
public class Test {
    public static void main(String[] args) throws MalformedURLException, Exception {
        Map<Integer, JdbcTypeInformation> typeMap = new HashMap<Integer, JdbcTypeInformation>();
        ...
        typeMap.values().forEach((v)->{
            FullyQualifiedJavaType fullyQualifiedJavaType = v.getFullyQualifiedJavaType();
            String fullyQualifiedNameWithoutTypeParameters = fullyQualifiedJavaType.getFullyQualifiedName();
            set.add(fullyQualifiedNameWithoutTypeParameters);
        });
        ...
        typeMap.values().forEach((v)->{
            ...
            set1.add(fullyQualifiedNameWithoutTypeParameters);
        });
